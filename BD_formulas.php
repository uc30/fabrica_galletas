...
<html>
    ...
    <body>
        ...
        <?php
            ...
            function error($letrero,$color){
                echo "<br><br><center>";
                if ($color=='rojo') echo "<table border='3' width='70%' bgcolor='red'>";
                if ($color=='verde') echo "<table border='3' width='70%' bgcolor='green'>";
                echo "
                <tr align='center'>
                            <td><font class='letrero'>$letrero</font></td>
                        </tr>
                    </table>
                    </center>
                ";
            ...
            function consultas(){
                global $formula_nom;
                $cs = mysqli_connect("localhost","root","","fabrica_galletas");
                $q="SELECT * FROM formulas WHERE form_nom='$formula_nom'";
                $sql=mysqli_query($cs,$q);
                $reg=mysqli_fetch_object($sql);
                if ($reg==mysqli_fetch_array($sql)){
                    error("La clave de producto es inexistente en la base de datos","rojo");
                }
                else{
                   error("La clave de e en la base de datos","verde");
                }
            }
            ...
            function formulario($formula_nom){
                ...
                echo'
                    ...
                    <form name="f_formulas" method="get">
                        ...
                        <input type="submit" value="¡Hecho!" name="hecho" class="button button2PHP" onclick="myFunction()">
                        <script>
                        function myFunction() {

                            x=0;
                            if (x==0) {
                                alert("La fórmula ya está en la base de datos");
                            }else{
                                alert("no");
                            }
                        }
